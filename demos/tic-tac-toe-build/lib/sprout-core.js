...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(appScope, appName) {
  ...
  function _defineElementFromTemplate() {
    _defineElementFromTemplate = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(template, elemName, globalStyle) {
          ...
          case 0:
            ...
            customElements.define(elemName, /*#__PURE__*/function (_appScope$ReactiveEle) {
              function _class() {
                ...
                return _callSuper(this, _class, [templateContent, runtime, style === null || style === void 0 ? void 0 : style.textContent, globalStyle === null || globalStyle === void 0 ? void 0 : globalStyle.textContent]);
              }
...
function extendElementClassWithReactiveElementClass(elementClass) {
  ...
  var ReactiveElement = /*#__PURE__*/function (_elementClass) {
    function ReactiveElement() {
      ...
      var globalStyle = arguments.length > 3 ? arguments[3] : undefined;
      ...
      if (!_this.isNativeElement) {
        _classPrivateFieldSet(_templateContent, _this, document.createElement("div"));
        if (runtimeScript) {
    ...
    return _createClass(ReactiveElement, [{
      ...
      value: function connectedCallback() {
        ...
        if (!this.isNativeElement) {
          ...
          if (_classPrivateFieldGet(_onMount, this)) _classPrivateFieldGet(_onMount, this).call(this, this.host || this, appScope[_consts_js__WEBPACK_IMPORTED_MODULE_1__.GLOBAL_STATE_FUNCTION_NAME]());
        }
      ...
      value: function getState(stateProp) {
        ...
        var thisInstance = this.isNativeElement ? this.host : this;
  ...
  function _setActiveStateFromInitialState() {
    ...
    if (initialState !== null && initialState !== void 0 && initialState._stateManager) {
      this.state = initialState === null || initialState === void 0 ? void 0 : initialState._stateManager.state;
    } else {
  ...
  function _unbindEvents() {
    ...
    _classPrivateFieldGet(_boundEventNames, this).forEach(function (eventName) {
      thiselement.removeEventListener(eventName, _classPrivateFieldGet(_eventHandler, _this3), false);
    });
  ...
  function _bindEvents() {
    ...
    eventRefNames.forEach(function (refName) {
      var value = _classPrivateFieldGet(_events, _this4)[refName];
    ...
    _classPrivateFieldSet(_eventHandler, this, function (event, eventsObject, refNames) {
    ...
    if (Object.keys(clickActions).length) {
      thiselement.addEventListener('click', function (event) {
        _classPrivateFieldGet(_eventHandler, _this4).call(_this4, event, clickActions, clickRefNames);
      }, false);
    ...
    var _loop = function _loop() {
      ...
      thiselement.addEventListener(eventName, function (event) {
        _classPrivateFieldGet(_eventHandler, _this4).call(_this4, event, otherActions[eventName], eventRefNames);
      }, false);
    };
...
var StateManager = /*#__PURE__*/function () {
  ...
  function StateManager(initialState, parentStateProp, parentStateManager) {
    ...
    Object.defineProperty(this.state, "_stateManager", {
      value: this,
      configurable: false,
      writable: _consts_js__WEBPACK_IMPORTED_MODULE_2__.DEBUG_MODE ? true : false,
      enumerable: false
    });
    ...
    if (!isGlobal) this.state._global = appScope[_consts_js__WEBPACK_IMPORTED_MODULE_2__.GLOBAL_STATE_FUNCTION_NAME]();else {
  ...
  return _createClass(StateManager, [{
    ...
    value: function setAndBindStateProperty(stateProp) {
      ...
      if (!descriptor) {
        stateObj = stateObj._global;
        Object.getOwnPropertyDescriptor(stateObj, stateProp), _readOnlyError("descriptor");
        if (!descriptor) {
...
function mapStateToElements(stateItemsPropertyName, customElementName, parentElement) {
  ...
  var elements = (0,_state_utils_js__WEBPACK_IMPORTED_MODULE_0__.mapStateArrayToElements)(stateItemsArray, customElementName);
  parentElement.innerHTML = "";
  if (elements.length) parentElement.append.apply(parentElement, _toConsumableArray(elements));
  return theState;
}
...
if (_consts_js__WEBPACK_IMPORTED_MODULE_1__.DEBUG_MODE) {
  COMMANDS = (0,_debug_utils_js__WEBPACK_IMPORTED_MODULE_2__.putObjectInDebugMode)(COMMANDS, "COMMANDS");
}
...
var BUILT_IN_STATE_PROPS = ['_global', '_gettingDependenciesFor', '_localStateManager', '_stateManager'];
// This is an object used to represent pending node actions,
// that are batched and executed in reflows (requestAnimationFrame)
var getNewNodeActionsObject = function getNewNodeActionsObject() {
  return {
...
function debugApplyProxyHandler(funcName, scopeName) {
  return {
    construct: function construct(target, args, newTarget) {
      ...
      if (funcName.indexOf('HTMLInputElement') !== -1) {
        debugger;
      }
...
var StateHandler = function StateHandler(stateObj) {
  ...
  return {
    defineProperty: function defineProperty(targetState, stateProp, descriptor) {
      if (_consts_js__WEBPACK_IMPORTED_MODULE_3__.BUILT_IN_STATE_PROPS.includes(stateProp)) {
        return Reflect.defineProperty.apply(Reflect, arguments);
      }
      ...
      var stateManager = stateObj._stateManager;
      (0,_state_utils_js__WEBPACK_IMPORTED_MODULE_1__.handleStateChange)(stateManager, stateProp);
...
function resolveNodeActionsMapToDOMActions() {
  ...
  nodeActionsMap.forEach(function (nodeActions, node) {
    ...
    // DOM change
      ...
      nodeActions.remove.forEach(function (nodeToRemove) {
      ...
      nodeActions.append.forEach(function (customElementName, stateItem) {
        batchActions.push(function () {
          return node.appendChild(stateToElement(stateItem, customElementName));
        });
      });
    }
  });
...
function generateStateNodeActions(stateManager, stateProp) {
  ...
  if (stateMaps) {
    ...
    stateMaps.forEach(function (_ref) {
      ...
      if (!nodeActionsMap.has(parentElement)) nodeActionsMap.set(parentElement, (0,_consts_js__WEBPACK_IMPORTED_MODULE_0__.getNewNodeActionsObject)());
      var nodeActions = nodeActionsMap.get(parentElement);
...
function populateStateFromInitialState(state, initialState) {
  ...
  for (var key in descriptors) {
    ...
    if (descrp.hasOwnProperty('value') && typeof descrp.value === "function") {
      descrp.value.bind(state);
    }
    if (key.indexOf('set_') === 0 && descrp.value && Array.isArray(descrp.value)) {
      var setStateArray = descrp.value;
      var setStateProp = key.substring(4);
      var func = setStateArray[0];
      // The third argument is a boolean stating if the function should run on first initialize
      var shouldRun = setStateArray[2];
      if (shouldRun && func && typeof func === "function") {
        setHooksToRun.add({
          stateProp: setStateProp,
          func: func
        });
      } else {
        if (setStateArray[3]) {
          var defaultValue = setStateArray[3];
          state[setStateProp] = defaultValue;
        }
      }
    }
  }
  Object.defineProperties(state, descriptors);
  if (setHooksToRun.size) {
    setHooksToRun.forEach(function (_ref2) {
      var stateProp = _ref2.stateProp,
        func = _ref2.func;
      state[stateProp] = func.call(state);
    });
  }
}
...
globalThis.SproutInitApp = function (appName) {
  ...
  if (_consts_js__WEBPACK_IMPORTED_MODULE_3__.DEBUG_MODE) {
    appScope = (0,_debug_utils_js__WEBPACK_IMPORTED_MODULE_5__.putObjectInDebugMode)(appScope, "appScope");
  } else {
    Object.defineProperty(this, "appScope", {
      value: appScope,
      writable: false
    });
  }
  ...
  appScope.setGlobalState = function () {
    ...
    (0,_state_utils_js__WEBPACK_IMPORTED_MODULE_2__.populateStateFromInitialState)(globalState, initialState);
  ...
  return function () {
    ...
    requestAnimationFrame(_state_utils_js__WEBPACK_IMPORTED_MODULE_2__.doUpdateDOM);
  }.bind(appScope);
};
/******/ })()
;

...
module.exports = {
  ...
  output: {
    ...
    path: path.resolve(__dirname, 'demos/todo-list-build/lib'),  // Output to the demo directory
  ...
  devServer: {
    static: {
      directory: path.join(__dirname, 'demos/todo-list-build'),  // Serve the demo directory
    },
    compress: true,
    port: 8000,
    hot: true,

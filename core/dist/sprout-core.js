...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   getConditionalElementClass: () => (/* binding */ getConditionalElementClass),
/* harmony export */   resolveConditional: () => (/* binding */ resolveConditional)
/* harmony export */ });
/* harmony import */ var _attr_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./attr_utils */ "./src/core/attr_utils.js");
/* harmony import */ var _consts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./consts */ "./src/core/consts.js");
/* harmony import */ var _paint_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./paint_utils */ "./src/core/paint_utils.js");
...
function resolveConditional(conditional, conditionStateValue) {
  var typeOf = _typeof(conditional);
  if (typeOf !== 'string') {
    return conditionStateValue === conditional;
  } else {
    if (conditional === "always") return true;
    if (_consts__WEBPACK_IMPORTED_MODULE_0__.CONDITIONAL_OPERATORS.includes(conditional[0])) {
...
function getConditionalElementClass(ReactiveElementClass) {
  ...
  var ConditionalElement = /*#__PURE__*/function (_ReactiveElementClass) {
    function ConditionalElement() {
      var _this;
      _classCallCheck(this, ConditionalElement);
      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }
      _this = _callSuper(this, ConditionalElement, [].concat(args));
      _classPrivateFieldInitSpec(_this, _conditionStateProp, void 0);
      _classPrivateFieldInitSpec(_this, _renderMap, void 0);
      _classPrivateFieldInitSpec(_this, _wasMounted, false);
      return _this;
    }
    _inherits(ConditionalElement, _ReactiveElementClass);
    return _createClass(ConditionalElement, [{
      key: "render",
      value: function render() {
        var _this2 = this;
        var isFirstRender = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
        var stateValue;
        if (_classPrivateFieldGet(_conditionStateProp, this).indexOf('@') === 0) {
          stateValue = this.host.getAttribute(_classPrivateFieldGet(_conditionStateProp, this).substring(1));
        } else {
          stateValue = this.getState(_classPrivateFieldGet(_conditionStateProp, this));
        }
        if (stateValue === undefined) {
          throw Error("State value for ".concat(_classPrivateFieldGet(_conditionStateProp, this), " not found while rendering conditional-render element:"), this);
        }
        var elementsToRender = [];
        _classPrivateFieldGet(_renderMap, this).forEach(function (elements, conditional) {
          if (resolveConditional(conditional, stateValue)) {
            elementsToRender.push.apply(elementsToRender, _toConsumableArray(elements));
          }
        });
        if (isFirstRender) {
          this.innerHTML = "";
          ...
          (0,_paint_utils__WEBPACK_IMPORTED_MODULE_1__.queueConditionalRender)(this, function () {
            _this2.innerHTML = "";
      ...
      value: function connectedCallback() {
        ...
        _classPrivateFieldSet(_conditionStateProp, this, statePropName);
        var isConditionStatic = _classPrivateFieldGet(_conditionStateProp, this).indexOf('@') === 0;
        var stateValue, stateObject;
        if (!isConditionStatic) {
          var _this$getState = this.getState(statePropName, true);
          var _this$getState2 = _slicedToArray(_this$getState, 2);
        ...
        children.forEach(function (conditionalChild) {
          ...
          if (_if) {
            var expectedValue = (0,_attr_utils__WEBPACK_IMPORTED_MODULE_2__.attributeValueToTypedValue)(_if);
        ...
        _classPrivateFieldSet(_renderMap, this, renderMap);
        if (!isConditionStatic) {
...
function extendElementClassWithReactiveElementClass(elementClass) {
  ...
  var ReactiveElement = /*#__PURE__*/function (_elementClass) {
    function ReactiveElement() {
      ...
      _this.isSpecialElement = _this.tagName === "CONDITIONAL-ELEMENT";
      _this.isNativeElement = _this.hasAttribute("is") && !_this.isSpecialElement;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   attributeValueToTypedValue: () => (/* binding */ attributeValueToTypedValue),
/* harmony export */   isSpecialAttribute: () => (/* binding */ isSpecialAttribute)
/* harmony export */ });
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
// Convert attribute values to "typed" values
function attributeValueToTypedValue(attrValue) {
  var typedValue = attrValue;
  if (attrValue === "true" || attrValue === "false") typedValue = Boolean(attrValue === "true");else if (!isNaN(Number(attrValue))) typedValue = Number(attrValue);
  return typedValue;
}

// Check if attribute node is a "Command" or a "State Attribute" 
function isSpecialAttribute(attrNode) {
  if (_typeof(attrNode) !== "object" && attrNode.constructor.name !== "Attr") throw Error("Passed non Attribute to isSpecialAttribute!");
...
{
  "class": /*#__PURE__*/function (_HTMLElement) {
    function _class() {
      _classCallCheck(this, _class);
...
globalThis.SproutInitApp = function (appName) {
  ...
  var ReactiveConditionalElementClass = (0,_ReactiveElement_js__WEBPACK_IMPORTED_MODULE_3__.extendElementClassWithReactiveElementClass)(HTMLElement, appScope, true);
